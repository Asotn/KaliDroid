...
#define LOG_TAG "KaliDroid-PkgJNI"
...
Java_com_rotlqe_kalidroid_engine_PackageEngine_nativeAptInit(
...
Java_com_rotlqe_kalidroid_engine_PackageEngine_nativeAptUpdate(
        JNIEnv *env, jobject) {
    char out[65536] = {0};
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_rotlqe_kalidroid_engine_PackageEngine_nativeAptInstall(
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_rotlqe_kalidroid_engine_PackageEngine_nativeAptRemove(
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_rotlqe_kalidroid_engine_PackageEngine_nativeAptSearch(
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_rotlqe_kalidroid_engine_PackageEngine_nativeAptShow(
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_rotlqe_kalidroid_engine_PackageEngine_nativeAptUpgrade(
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_rotlqe_kalidroid_engine_PackageEngine_nativeAptFixBroken(
        JNIEnv *env, jobject) {
    char out[16384] = {0};
...
Java_com_rotlqe_kalidroid_engine_PackageEngine_nativeDpkgIsInstalled(
        JNIEnv *env, jobject, jstring pkg) {
    return (jboolean)dpkg_is_installed(jstr2std(env, pkg).c_str());
}

extern "C" JNIEXPORT jstring JNICALL
Java_com_rotlqe_kalidroid_engine_PackageEngine_nativeDpkgGetVersion(
        JNIEnv *env, jobject, jstring pkg) {
    char ver[256] = {0};
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_rotlqe_kalidroid_engine_PackageEngine_nativeDpkgListInstalled(
        JNIEnv *env, jobject) {
    char out[131072] = {0};
...
Java_com_rotlqe_kalidroid_engine_PackageEngine_nativeDpkgInstalledCount(
        JNIEnv *, jobject) {
...
extern "C" JNIEXPORT jboolean JNICALL
Java_com_rotlqe_kalidroid_engine_PackageEngine_nativeRepoCheckConnectivity(
...
extern "C" JNIEXPORT void JNICALL
Java_com_rotlqe_kalidroid_engine_PackageEngine_nativeRepoWriteSourcesList(
        JNIEnv *, jobject) {
