...
import com.rotlqe.kalidroid.engine.NativeTerminal;
import com.rotlqe.kalidroid.terminal.CommandProcessor;
import com.rotlqe.kalidroid.terminal.TabCompletionEngine;
import com.rotlqe.kalidroid.terminal.TerminalSession;
import com.rotlqe.kalidroid.utils.AppPreferences;
...
public class TerminalActivity extends AppCompatActivity {
    ...
    private static final String TAG = "KaliDroid-Main";
    ...
    private void bindViews() {
        ...
        if (tb != null) {
            ...
            if (getSupportActionBar() != null) getSupportActionBar().setTitle("KaliDroid");
        }
    ...
    private void startSession() {
        try {
            ...
            appendColored("[KaliDroid] Could not start session: " + t.getMessage() + "\n", C_RED);
        }
    }
    ...
    private void showWelcome() {
        ...
        appendColored("  Kali Linux Terminal for Android  v1.0.0\n", C_WHITE);
        appendColored("  Developer : github.com/Rotlqe  |  s.pi@outlook.sa\n", C_GRAY);
        ...
        appendColored("\n  Type kalidroid-help for commands.\n", C_CYAN);
    ...
    private void safeRecoverUI(Throwable t) {
        try {
            ...
            if (out != null) out.setText("[KaliDroid] Startup error — " + t.getMessage() +
