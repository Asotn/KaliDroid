...
public class BootstrapService extends Service {
    ...
    private static final String TAG     = "KaliDroid-Bootstrap";
    private static final int    NOTIF_ID = 3001;

    public static final String ACTION_START  = "com.rotlqe.kalidroid.BOOTSTRAP_START";
    public static final String BROADCAST_DONE    = "com.rotlqe.kalidroid.BOOTSTRAP_DONE";
    public static final String BROADCAST_ERROR   = "com.rotlqe.kalidroid.BOOTSTRAP_ERROR";
    public static final String BROADCAST_PROGRESS = "com.rotlqe.kalidroid.BOOTSTRAP_PROGRESS";
    ...
    private Notification buildNotification(String text, int progress) {
        ...
        NotificationCompat.Builder builder =
            new NotificationCompat.Builder(this, KaliDroidApp.CHANNEL_ID_BOOTSTRAP)
                .setSmallIcon(R.drawable.ic_notification)
                .setContentTitle("KaliDroid Setup")
                .setContentText(text)
                .setOngoing(true)
                .setContentIntent(pi);
