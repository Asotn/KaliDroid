...
public class CommandProcessor {
    ...
    private static final String TAG = "KaliDroid-CMD";
    ...
    public static CommandResult process(String raw, Context ctx) {
        ...
        // kalidroid-help / help (only as standalone commands)
        if (lower.equals("kalidroid-help") || lower.equals("kalidroid --help")) {
            return new CommandResult(CommandType.HELP, buildHelpText(), null);
        }

        // kalidroid-about
        if (lower.equals("kalidroid-about") || lower.equals("about")) {
            return new CommandResult(CommandType.ABOUT, buildAboutText(), null);
        }

        // settings
        if (lower.equals("kalidroid-settings") || lower.equals("settings")) {
    ...
    private static String buildHelpText() {
        return "\r\n" +
            "KaliDroid Terminal - Built-in Commands\r\n" +
            "======================================\r\n" +
            "\r\n" +
            ...
            "  kalidroid-settings      Open app settings\r\n" +
            "  kalidroid-help          Show this help message\r\n" +
            "\r\n" +
