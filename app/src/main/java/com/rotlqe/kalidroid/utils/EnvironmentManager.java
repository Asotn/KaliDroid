...
public class EnvironmentManager {
    ...
    private static final String TAG = "KaliDroid-Env";
    ...
    // Kali repos
    public static final String KALI_MIRROR    = "http://http.kali.org/kali";
    ...
    public static String[] buildShellArgs(boolean useLogin) {
        ...
        args.add("--bind=" + FILES_DIR + ":/kalidroid");
    ...
    public static boolean isStorageAccessGranted() {
        File test = new File("/sdcard/.kalidroid_test");
        try {
